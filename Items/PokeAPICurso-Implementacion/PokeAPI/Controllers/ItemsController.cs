        ...
        public ActionResult<List<Items>> ObtenerItemsCompleto()
        {
            try
            {
                ...
                using SqlConnection conexionBase = new SqlConnection(
                    "Data Source=(localdb)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\USUARIO\\Documents\\ItemsUTN\\Items\\PokeApiCurso-Implementacion\\PokeApi\\PokeDB.mdf;Integrated Security=True"
                );
